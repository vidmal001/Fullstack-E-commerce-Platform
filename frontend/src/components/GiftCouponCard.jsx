...
const GiftCouponCard = () => {
  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <input
            ...
            className="block w-full rounded-lg border border-gray-600 bg-gray-700 
              p-2.5 text-sm text-white placeholder-gray-400 
      ...
      {/** Once we buy something that worth more than 200$ for the next shopping this is gonna give us a gift card that will have 10% discount */}
